...
Gem::Specification.new do |spec|
  spec.name          = "lastpass-indicator"
  spec.version       = LastPassIndicator::VERSION
  spec.authors       = ["Nicholas Hinds"]
  spec.email         = ["hindsn@gmail.com"]
  spec.summary       = %q{Indicator for inserting passwords from LastPass into linux applications.}
  spec.description   = %q{Indicator for inserting passwords from LastPass into linux applications.}
  spec.homepage      = ""
  spec.license       = "MIT"
